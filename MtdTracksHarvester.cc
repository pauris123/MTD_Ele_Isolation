...
private:
  ...
  MonitorElement* mePtEffMTD_;
  MonitorElement* meEtaEffMTD_;
  MonitorElement* mePhiEffMTD_;
...
void MtdTracksHarvester::dqmEndJob(DQMStore::IBooker& ibook, DQMStore::IGetter& igetter) {
  ...
  MonitorElement* meEle_pt_MTD = igetter.get(folder_ + "Ele_pT_MTD");
  ...
  MonitorElement* meEle_eta_MTD = igetter.get(folder_ + "Ele_eta_MTD");
  ...
  MonitorElement* meEle_phi_MTD = igetter.get(folder_ + "Ele_phi_MTD");
  ...
  if (!meBTLTrackEffEtaTot || !meBTLTrackEffPhiTot || !meBTLTrackEffPtTot || !meBTLTrackEffEtaMtd ||
      ...
      !meNTrackingParticles || !meUnassDeposit || !meEle_pt_tot || !meEle_pt_MTD || !meEle_pt_noMTD || !meEle_eta_tot || !meEle_eta_MTD || !meEle_eta_noMTD || 
      !meEle_phi_tot || !meEle_phi_MTD || !meEle_phi_noMTD) {
  ...
  // MTD vs noMTD iso eficiencies added

  mePtEffMTD_ = ibook.book1D("pTeffMTD",
  ...
  mePtEffMTD_->getTH1()->SetMinimum(0.);
  computeEfficiency1D(meEle_pt_MTD, meEle_pt_tot, mePtEffMTD_);

  meEtaEffMTD_ = ibook.book1D("EtaEffMTD",
  ...
  meEtaEffMTD_->getTH1()->SetMinimum(0.);
  computeEfficiency1D(meEle_eta_MTD, meEle_eta_tot, meEtaEffMTD_);

  mePhiEffMTD_ = ibook.book1D("PhiEffMTD",
  ...
  mePhiEffMTD_->getTH1()->SetMinimum(0.);
  computeEfficiency1D(meEle_phi_MTD, meEle_phi_tot, mePhiEffMTD_);
