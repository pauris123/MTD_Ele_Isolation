...
public:
    MTD_Ele_iso(float min_dR_cut,
                ...
                edm::Handle <reco::VertexCollection> vertexCol) // same as above
    ...
    std::tuple<int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float> ele_iso(const reco::GsfTrack*) const ; // const at the end???
