...
void MtdTracksValidation::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  //desc.add<edm::InputTag>("inputEle", edm::InputTag("gedGsfElectrons")); // Adding the electron collection name ! (At least I think I'm doing that) // barrel ecal and track driven electrons
