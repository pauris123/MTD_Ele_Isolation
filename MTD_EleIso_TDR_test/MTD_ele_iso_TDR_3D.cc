...
std::tuple<int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int> MTD_Ele_iso::ele_iso(const reco::GsfTrack* eleTrack) const {
      ...
      */
        //if(Vtx_chosen.trackWeight(ele_sigTrkRef) > 0.5){ // ele track inside vtx track coll cut
          ...
          for (const auto& trackGen : *Track_coll_) { // looping over all the tracks to get charged rel_iso for electrons
            ...
            if(dr_check > InConeSize_ && dr_check < OutConeSize_){
  ...
  //} // if statement for primary vertex- track fit check dz
    

std::tuple<int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int,float,float,int> iso_output;
...
N_tracks_MTD_5,pT_sum_MTD_5,rel_pT_sum_MTD_5 , N_tracks_MTD_6,pT_sum_MTD_6,rel_pT_sum_MTD_6 , N_tracks_MTD_7,pT_sum_MTD_7,rel_pT_sum_MTD_7, tracks_in_cone_full);
